...
public abstract class RecordingJtlVisitor implements Visualizer {
  ...
  public void visit(InputStream resultsInputStream) throws IOException {
  ...
  private void visitHttpResult(HTTPSampleResult sample) {
    ...
    if (!contentTypeMatcher.find() || !Type.TEXT_HTML.toString()
        .equals(contentTypeMatcher.group(1))) {
      return;
    }
